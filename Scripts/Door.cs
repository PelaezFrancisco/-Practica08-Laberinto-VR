...
public class Door : MonoBehaviour {
    ...
    void Start () {
        ...
        AudioSource audioSource = GetComponent("Door_Opening") as AudioSource;
        ...
        leftDoorStartRotation = Quaternion.Euler(-90f, 180f, -90f);
        ...
        rightDoorStartRotation = Quaternion.Euler(-90.0f, 0f, -90.0f);
