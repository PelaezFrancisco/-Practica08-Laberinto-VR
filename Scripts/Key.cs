...
public class Key : MonoBehaviour {
	...
	public void OnKeyClicked () {
        ...
        Instantiate(KeyPoofPrefab, new Vector3(key.transform.position.x, key.transform.position.y, key.transform.position.z), Quaternion.identity);
